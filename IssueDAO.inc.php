...
class IssueDAO extends DAO {
	...
	function &getCurrentIssue($journalId, $useCache = false) {
		...
		$result =& $this->retrieve('SELECT i.* FROM issues i WHERE journal_id = ? AND current = 1', $journalId);
	...
	function getLocaleFieldNames() {
		return array('title', 'coverPageDescription','tapaPageDescription', 'coverPageAltText', 'showCoverPage','showTapaPage','showContraTapaPage', 'hideCoverPageArchives', 'hideCoverPageCover', 'originalFileName', 'fileName', 'originalTapaName', 'tapaName','originalContraTapaName', 'contraTapaName', 'width', 'height', 'description');
	}
