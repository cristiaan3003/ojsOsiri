...
class Issue extends DataObject {
	...
	//-----------------------------------------------------------------
	/**
	 * Get the localized issue tapa filename
	 * @return string
	 */
	function getLocalizedTapaName() {
		return $this->getLocalizedData('tapaName');
	}

	function getIssueTapaName() {
		if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
		return $this->getLocalizedTapaName();
	}

	/**
	 * Get issue tapa image file name
	 * @param $locale string
	 * @return string
	 */
	function getTapaName($locale) {
		return $this->getData('tapaName', $locale);
	}

	/**
	 * set file name
	 * @param $tapaName string
	 * @param $locale string
	 */
	function setTapaName($tapaName, $locale) {
		return $this->setData('tapaName', $tapaName, $locale);
	}
	...
	//-----------------------------------------------------------------
	/**
	 * Get the localized issue contra tapa filename
	 * @return string
	 */
	function getLocalizedContraTapaName() {
		return $this->getLocalizedData('contraTapaName');
	}

	function getIssueContraTapaName() {
		if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
		return $this->getLocalizedContraTapaName();
	}

	/**
	 * Get issue contratapa image file name
	 * @param $locale string
	 * @return string
	 */
	function getContraTapaName($locale) {
	 ...
	 * @param $locale string
	 */
	function setContraTapaName($contraTapaName, $locale) {
	...
	//----------------------------------------------------------------------------
	/**
	 * Get the localized issue tapa filename on the uploader's computer
	 * @return string
	 */
	function getLocalizedOriginalTapaName() {
		return $this->getLocalizedData('originalTapaName');
	}

	function getIssueOriginalTapaName() {
		if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
		return $this->getLocalizedOriginalTapaName();
	}

	/**
	 * Get original issue tapa image file name
	 * @param $locale string
	 * @return string
	 */
	function getOriginalTapaName($locale) {
		return $this->getData('originalTapaName', $locale);
	}

	/**
	 * set original file name
	 * @param $originalTapaName string
	 * @param $locale string
	 */
	function setOriginalTapaName($originalTapaName, $locale) {
		return $this->setData('originalTapaName', $originalTapaName, $locale);
	}
	//---------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------
	/**
	 * Get the localized issue contratapa filename on the uploader's computer
	 * @return string
	 */
	function getLocalizedOriginalContraTapaName() {
		return $this->getLocalizedData('originalContraTapaName');
	}

	function getIssueOriginalContraTapaName() {
		if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
		return $this->getLocalizedOriginalContraTapaName();
	}

	/**
	 * Get original issue contratapa image file name
	 * @param $locale string
	 * @return string
	 */
	function getOriginalContraTapaName($locale) {
		return $this->getData('originalContraTapaName', $locale);
	}

	/**
	 * set original file name
	 * @param $originalContraTapaName string
	 * @param $locale string
	 */
	function setOriginalContraTapaName($originalContraTapaName, $locale) {
		return $this->setData('originalContraTapaName', $originalContraTapaName, $locale);
	}
	//---------------------------------------------------------------------------
	...
	/**
	 * Get the localized issue Tapa description
	 * @return string
	 */
	function getLocalizedTapaPageDescription() {
		return $this->getLocalizedData('tapaPageDescription');
	}

	function getIssueTapaPageDescription() {
		if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
		return $this->getLocalizedTapaPageDescription();
	}

	/**
	 * get tapa page description
	 * @param $locale string
	 * @return string
	 */
	function getTapaPageDescription($locale) {
		return $this->getData('tapaPageDescription', $locale);
	}

	/**
	 * set cover page description
	 * @param $tapaPageDescription string
	 * @param $locale string
	 */
	function setTapaPageDescription($tapaPageDescription, $locale) {
		return $this->setData('tapaPageDescription', $tapaPageDescription, $locale);
	}
...
//--------------------------------------------
	/**
	 * Get the localized issue Tapa enable/disable flag
	 * @return string
	 */
	function getLocalizedShowTapaPage() {
		return $this->getLocalizedData('showTapaPage');
	}

	function getIssueShowTapaPage() {
		if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
		return $this->getLocalizedShowTapaPage();
	}

	/**
	 * Get show issue Tapa image flag
	 * @param $locale string
	 * @return int
	 */
	function getShowTapaPage($locale) {
		return $this->getData('showTapaPage', $locale);
	}

	/**
	 * Set show issue Tapa image flag
	 * @param $showTapaPage int
	 * @param $locale string
	 */
	function setShowTapaPage($showTapaPage, $locale) {
		return $this->setData('showTapaPage', $showTapaPage, $locale);
	}
	
//----------------------------------	

/**
	 * Get the localized issue ContraTapa enable/disable flag
	 * @return string
	 */
	function getLocalizedShowContraTapaPage() {
		return $this->getLocalizedData('showContraTapaPage');
	}

	function getIssueShowContraTapaPage() {
		if (Config::getVar('debug', 'deprecation_warnings')) trigger_error('Deprecated function.');
		return $this->getLocalizedShowContraTapaPage();
	}

	/**
	 * Get show issue ContraTapa image flag
	 * @param $locale string
	 * @return int
	 */
	function getShowContraTapaPage($locale) {
		return $this->getData('showContraTapaPage', $locale);
	}

	/**
	 * Set show issue ContraTapa image flag
	 * @param $showContraTapaPage int
	 * @param $locale string
	 */
	function setShowContraTapaPage($showContraTapaPage, $locale) {
		return $this->setData('showContraTapaPage', $showContraTapaPage, $locale);
	}
//----------------------------------		
